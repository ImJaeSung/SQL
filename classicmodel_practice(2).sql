...
select count(*) from customers c 
	...
	on e.employeeNumber = c.salesRepEmployeeNumber; # 122개가 존재한다.

# left outer join 시
select count(*) from customers c 
	left outer join employees e 
	on e.employeeNumber = c.salesRepEmployeeNumber; # 122 개가 존재한다.

# inner join 
select count(*) from customers c 
	inner join employees e 
	on e.employeeNumber = c.salesRepEmployeeNumber; # 100개가 존재
...
select count(*) from employees e  
	...
	where c.salesRepEmployeeNumber is null; #108개 존재

select * from employees e  
	left outer join customers c 
	on e.employeeNumber = c.salesRepEmployeeNumber
	where e.employeenumber = '1165'; # 108개 존재

select * from employees e  
	inner join customers c 
	on e.employeeNumber = c.salesRepEmployeeNumber
	where e.employeenumber = '1165'; # 100개 존재
...
select  c.customernumber, c.city, c.country, o.orderNumber, o.orderdate from customers c
